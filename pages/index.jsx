          ...
          <div className={`${styles.home__container}` + " container grid"}>
            <div className={`${styles.home__content}` + " container grid"}>
              ...
              <div className={styles.home__social}>
                ...
                <a
                  href="https://github.com/louiskwt"
                  target="_blank"
                  className={styles.home__social__icon}
                >
                ...
                <a
                  href="https://twitter.com/kawingt2"
                  target="_blank"
                  className={styles.home__social__icon}
                >
                ...
                <svg className={styles.home__blob} viewBox="0 0 200 187">
                  ...
                  <g mask="url(#mask0)">
                    ...
                    <image
                      ...
                      className={styles.home__blob__img}
                    />
                  </g>
                </svg>
              </div>
              <div className={styles.home__data}>
                <h1 className={styles.home__title}>Hi, I'm Louis</h1>
                <h3>Web Developer from HK</h3>
                <p className={styles.home__description}>
                  Experienced in developing modern web applications with
                  JavaScript, React, Firebase, NodeJS, MongoDB, and more.
                  <br />
                  <br />
